...
const manageSpinner=(status)=>{
  if(status==true){
    ...
    document.getElementById("word-container").classList.add("hidden") //load hole word container hide hoye jabe
  }
  else{
...
const loadLevelWord=(id)=>{
  manageSpinner(true);
    ...
    .then((data)=>{
      ...
      clickBtn.classList.add("active");// add active class to the clicked ones
...
// }
    ...
    <div class="flex justify-between items-center">
      ...
      <button onclick="pronounceWord('${word.word}')" class="btn bg-[#1A91FF10] hover:bg-[#1A91FF80]"><i class="fa-solid fa-volume"></i></button>
    </div>
